...
import static com.csvdatahandling.advancedproblems.convertcsvdataintojavaobjects.ConvertingCSVDataintoJavaObjects.convertCSVDataintoJavaObjects;

public class ConvertCSVDataintoJavaObjects {
    public static void main(String[] args){
        // File path
        String filePath = "src/main/java/com/csvdatahandling/advancedproblems/convertcsvdataintojavaobjects/studentrecord.csv";
